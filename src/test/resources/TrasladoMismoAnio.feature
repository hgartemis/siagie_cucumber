...
Feature: Gestion de Traslados en el mismo año
  ...
  Scenario Outline: 09. Como usuario deseo ingresar y trasladar a un alumno en el mismo año del colegio innova al meliton Carbajal con los datos validos usando el codigo del alumno.
  ...
  Scenario Outline: 10. Como usuario deseo ingresar a gestion de traslado donde buscare el proceso de traslado y confirmar matricula de la constancia recepcionada.
    ...
    Examples:
      | usuario  | contrasena  | captcha | codigoModular | anioDestino | tipo traslado     | estado constancia             | codigo         | estado    |
      | 19100733 | 2021Siagie@ | abc     | 0245647       | 2021        | En el mismo año | Constancia recibida en origen | 07122331200030 | matricula |
